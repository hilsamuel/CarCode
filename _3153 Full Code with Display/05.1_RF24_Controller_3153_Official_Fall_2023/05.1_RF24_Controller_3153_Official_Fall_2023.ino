...
const byte addresses[6] = "TM001";// define communication address which should correspond to remote control
...
void setup() {
  ...
  radio.setRetries(10, 15);            // set the number and delay of retries
